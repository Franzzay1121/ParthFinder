...
import { Mail, Lock, User, Compass, ArrowRight, CheckCircle } from 'lucide-react';
...
const SignUpPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up | PathFinder</title>
        <meta name="description" content="Create your free PathFinder account and start discovering your ideal career path today." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background flex">
        ...
        <div className="hidden lg:flex flex-1 bg-gradient-hero items-center justify-center p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 text-primary-foreground max-w-md">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8">
              Join thousands of young people who have discovered their path with PathFinder.
            </p>
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            {/* Logo */}
            <Link to="/" className="flex items-center gap-2 text-xl font-bold text-foreground mb-8">
