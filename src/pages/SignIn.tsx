...
const SignInPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sign In | PathFinder</title>
        <meta name="description" content="Sign in to your PathFinder account to continue your career discovery journey." />
      </Helmet>
        ...
        <div className="hidden lg:flex flex-1 bg-gradient-hero items-center justify-center p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center text-primary-foreground max-w-md">
            ...
            <p className="text-xl text-primary-foreground/80">
              Sign in to access your personalized career roadmap, saved progress, and exclusive resources.
            </p>
          </div>
        </div>
      </div>
